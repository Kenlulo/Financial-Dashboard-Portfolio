...
_LANG = {
    ...
    '👉 **Nếu bạn muốn xem thêm dự án khác hãy [nhấp vào đây](https://portfolio-394g.vercel.app)**': '👉 **If you want to view more projects, please [click here](https://portfolio-394g.vercel.app)**',
